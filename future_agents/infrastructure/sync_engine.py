        ...
        if violations:
            ...
            improvements.append(
                Improvement(
                    ...
                    description=(
                        f"{len(violations)} tasks had policy violations across policies: {', '.join(unique_policies)}"  # noqa: E501
                    ),
                    priority=0.9,
        ...
        if len(failures) >= 2:
            improvements.append(
                Improvement(
                    ...
                    description=(
                        f"{len(failures)} tasks failed. Review processes and capability assignments."  # noqa: E501
                    ),  # noqa: E501
                    priority=0.8,
