...
SENIORITY_LEVELS = [
    ...
    "principal", "staff", "architect", "distinguished", "fellow"
]

INDUSTRIES = [
    "fintech", "healthtech", "edtech", "govtech", "retailtech",
    "legaltech", "insurtech", "proptech", "agrotech", "cleantech",
    "cybersecurity", "defense", "media", "telecom", "logistics",
    "automotive", "aerospace", "pharma", "gaming", "saas"
]

METHODOLOGIES = [
    "agile", "scrum", "kanban", "lean", "devops", "sre", "devsecops",
    "gitops", "platform-engineering", "shift-left", "chaos-engineering"
]
...
TECH_ROLE_CATEGORIES = {
    "frontend-development": {
        ...
        "tech_stacks": ["react", "vue", "angular", "svelte", "nextjs", "nuxt", "astro",
                        "vanilla-js", "typescript", "webcomponents", "lit", "qwik",
                        "remix", "solidjs", "htmx", "tailwindcss", "css-in-js"],
        "skills": ["ui-design", "accessibility", "performance", "seo", "pwa",
                   "micro-frontends", "design-systems", "testing", "state-management",
                   "graphql-client", "websockets", "webgl", "wasm"],
    ...
    "backend-development": {
        ...
        "tech_stacks": ["nodejs", "python-fastapi", "python-django", "java-spring",
                        "go", "rust", "ruby-on-rails", "php-laravel", "dotnet", "kotlin-ktor",
                        "elixir-phoenix", "haskell", "scala-play", "clojure", "erlang"],
        "skills": ["rest-api", "graphql", "grpc", "microservices", "monolith",
                   "event-driven", "cqrs", "ddd", "hexagonal-arch", "auth-authz",
                   "rate-limiting", "caching", "message-queues", "background-jobs"],
    ...
    "fullstack-development": {
        ...
        "tech_stacks": ["nextjs-node", "nuxt-node", "remix-node", "sveltekit",
                        "t3-stack", "blitzjs", "redwoodjs", "nestjs-react",
                        "django-react", "rails-react", "laravel-vue", "spring-react"],
        "skills": ["full-sdlc", "database-design", "api-design", "ui-ux",
                   "deployment", "monitoring", "ci-cd", "testing-full-stack"],
        "tools": ["monorepo-tools", "nx", "turborepo", "lerna"],
        "certifications": ["aws-saa", "gcp-ace"]
    },
    "mobile-development": {
        "description": "Build native and cross-platform mobile applications",
        "tech_stacks": ["ios-swift", "ios-objc", "android-kotlin", "android-java",
                        "react-native", "flutter", "xamarin", "ionic", "capacitor",
                        "expo", "kotlin-multiplatform", "swift-ui", "jetpack-compose"],
        "skills": ["app-store-optimization", "push-notifications", "offline-first",
                   "biometrics", "camera-apis", "gps-location", "bluetooth",
                   "in-app-purchases", "ar-mobile", "deep-linking", "accessibility"],
    ...
    "devops-engineering": {
        ...
        "tech_stacks": ["jenkins", "github-actions", "gitlab-ci", "circleci",
                        "azure-devops", "argocd", "tekton", "flux", "spinnaker",
                        "harness", "drone-ci", "bamboo"],
        "skills": ["ci-cd", "infrastructure-as-code", "gitops", "release-management",
                   "pipeline-design", "artifact-management", "environment-management",
                   "shift-left-testing", "feature-flags", "blue-green", "canary"],
    ...
    "platform-engineering": {
        ...
        "tech_stacks": ["backstage", "port", "cortex", "configure8",
                        "kubernetes", "crossplane", "pulumi", "terraform"],
        "skills": ["idp-design", "developer-experience", "self-service-infra",
                   "golden-paths", "platform-apis", "service-catalog",
    ...
    "sre-engineering": {
        ...
        "tech_stacks": ["prometheus", "grafana", "datadog", "newrelic", "dynatrace",
                        "honeycomb", "lightstep", "jaeger", "zipkin", "opentelemetry"],
        "skills": ["slo-sla-sli", "incident-management", "chaos-engineering",
                   "capacity-planning", "on-call-management", "post-mortem",
                   "toil-reduction", "observability", "tracing", "alerting"],
    ...
    "cloud-architecture": {
        ...
        "tech_stacks": ["aws", "azure", "gcp", "alibaba-cloud", "oracle-cloud",
                        "ibm-cloud", "digitalocean", "cloudflare", "fastly"],
        "skills": ["well-architected", "cost-optimization", "security-design",
                   "high-availability", "disaster-recovery", "multi-region",
                   "serverless", "containers", "hybrid-cloud", "data-architecture"],
    ...
    "security-engineering": {
        ...
        "tech_stacks": ["siem", "soar", "edr", "xdr", "sase", "zero-trust",
                        "identity", "pam", "dlp", "casb"],
        "skills": ["threat-modeling", "security-architecture", "iam", "pki",
                   "encryption", "key-management", "network-security",
                   "endpoint-security", "cloud-security", "data-security"],
    ...
    "appsec-engineering": {
        ...
        "tech_stacks": ["sast", "dast", "iast", "sca", "container-scanning",
                        "secret-scanning", "api-security", "waf"],
        "skills": ["secure-code-review", "threat-modeling", "pentest-web",
                   "owasp-top10", "devsecops", "security-testing",
                   "vulnerability-management", "sbom", "supply-chain-security"],
    ...
    "cloud-security": {
        ...
        "tech_stacks": ["aws-security", "azure-security", "gcp-security",
                        "cspm", "cwpp", "cnapp", "ciem"],
        "skills": ["cloud-iam", "cloud-networking-security", "data-security-cloud",
                   "compliance-cloud", "incident-response-cloud", "threat-detection"],
    ...
    "penetration-testing": {
        ...
        "tech_stacks": ["kali-linux", "parrot-os", "metasploit", "burpsuite",
                        "nmap", "bloodhound", "cobalt-strike", "sliver"],
        "skills": ["web-pentest", "network-pentest", "red-teaming", "social-engineering",
                   "physical-security", "wireless-pentest", "cloud-pentest",
                   "mobile-pentest", "api-pentest", "hardware-hacking"],
    ...
    "data-engineering": {
        ...
        "tech_stacks": ["apache-spark", "apache-kafka", "apache-flink", "apache-airflow",
                        "dbt", "dagster", "prefect", "databricks", "snowflake",
                        "bigquery", "redshift", "duckdb", "delta-lake", "apache-iceberg"],
        "skills": ["etl-elt", "stream-processing", "batch-processing", "data-modeling",
                   "data-quality", "data-governance", "data-catalog", "lakehouse",
                   "real-time-analytics", "cdc", "data-mesh"],
    ...
    "data-science": {
        ...
        "tech_stacks": ["python-pandas", "r", "julia", "scala", "sql",
                        "jupyter", "plotly", "tableau", "looker", "powerbi"],
        "skills": ["statistical-analysis", "data-visualization", "hypothesis-testing",
                   "regression", "classification", "clustering", "time-series",
                   "a-b-testing", "causal-inference", "storytelling"],
    ...
    "ml-engineering": {
        ...
        "tech_stacks": ["tensorflow", "pytorch", "jax", "keras", "huggingface",
                        "mlflow", "kubeflow", "ray", "bentoml", "triton",
                        "torchserve", "seldon", "kserve"],
        "skills": ["model-training", "feature-engineering", "hyperparameter-tuning",
                   "model-evaluation", "model-serving", "mlops", "monitoring-drift",
                   "explainability", "fairness", "distributed-training"],
    ...
    "ai-llm-engineering": {
        ...
        "tech_stacks": ["openai", "anthropic", "google-gemini", "meta-llama",
                        "mistral", "langchain", "llamaindex", "haystack",
                        "semantic-kernel", "autogen", "crewai", "dspy"],
        "skills": ["prompt-engineering", "rag", "fine-tuning", "agent-design",
                   "llm-evaluation", "llm-security", "context-management",
                   "embeddings", "vector-search", "llm-ops", "multi-modal"],
    ...
    "database-administration": {
        ...
        "tech_stacks": ["postgresql", "mysql", "oracle", "sqlserver", "db2",
                        "mongodb", "cassandra", "dynamodb", "redis", "elasticsearch",
                        "neo4j", "influxdb", "cockroachdb", "tidb", "vitess"],
        "skills": ["query-optimization", "index-design", "replication", "sharding",
                   "backup-recovery", "high-availability", "migration", "capacity-planning",
    ...
    "systems-administration": {
        ...
        "tech_stacks": ["linux", "windows-server", "macos-server",
                        "rhel", "ubuntu", "centos", "debian", "fedora",
                        "windows-ad", "openldap", "ansible", "puppet", "chef"],
        "skills": ["os-hardening", "patch-management", "user-management", "scripting",
                   "backup-restore", "monitoring", "performance-tuning",
                   "virtualization", "storage-management", "print-management"],
    ...
    "network-engineering": {
        ...
        "tech_stacks": ["cisco-ios", "juniper-junos", "aruba", "fortinet",
                        "paloalto", "checkpoint", "f5", "a10",
                        "sd-wan", "sase", "nfv", "sdn"],
        "skills": ["routing-switching", "firewall-management", "vpn", "load-balancing",
                   "network-monitoring", "traffic-analysis", "wireless", "voip",
                   "bgp-ospf-eigrp", "network-automation", "ipv6"],
    ...
    "embedded-systems": {
        ...
        "tech_stacks": ["c", "cpp", "rust-embedded", "micropython", "freertos",
                        "zephyr", "mbed", "arduino", "raspberry-pi", "stm32",
                        "esp32", "avr", "arm-cortex"],
        "skills": ["firmware-development", "rtos", "hardware-interfaces",
                   "low-power-design", "debugging-jtag", "bootloaders",
                   "device-drivers", "communication-protocols", "ota-updates"],
    ...
    "iot-engineering": {
        ...
        "tech_stacks": ["mqtt", "coap", "lorawan", "zigbee", "zwave", "ble",
                        "aws-iot", "azure-iot", "google-iot", "thingsboard",
                        "nodered", "home-assistant"],
        "skills": ["device-provisioning", "edge-computing", "fleet-management",
                   "telemetry-collection", "ota-firmware", "security-iot",
                   "data-ingestion", "digital-twin", "protocol-translation"],
    ...
    "blockchain-development": {
        ...
        "tech_stacks": ["ethereum", "solana", "polygon", "avalanche", "cosmos",
                        "hyperledger-fabric", "cardano", "near", "polkadot", "arbitrum"],
        "skills": ["smart-contracts", "defi-protocols", "nft-platforms",
                   "dao-governance", "cross-chain", "layer2", "wallet-integration",
                   "cryptography", "consensus-mechanisms", "tokenomics"],
    ...
    "game-development": {
        ...
        "tech_stacks": ["unity", "unreal-engine", "godot", "cryengine",
                        "pygame", "love2d", "phaser", "three-js", "playcanvas",
                        "opengl", "vulkan", "directx", "metal"],
        "skills": ["gameplay-programming", "physics-simulation", "ai-game",
                   "graphics-programming", "shader-development", "networking-game",
                   "audio-programming", "ui-hud", "optimization-game", "level-design"],
    ...
    "ar-vr-development": {
        ...
        "tech_stacks": ["unity-xr", "unreal-xr", "openxr", "webxr",
                        "arkit", "arcore", "vuforia", "reality-kit",
                        "oculus-sdk", "steamvr", "mixed-reality-toolkit"],
        "skills": ["spatial-computing", "3d-interaction", "hand-tracking",
                   "eye-tracking", "haptics", "spatial-audio", "world-mapping",
                   "6dof-locomotion", "avatar-systems", "real-time-rendering"],
    ...
    "qa-engineering": {
        ...
        "tech_stacks": ["selenium", "playwright", "cypress", "webdriverio",
                        "appium", "detox", "espresso", "xcuitest",
                        "jest", "pytest", "junit", "testng", "nunit"],
        "skills": ["test-strategy", "test-planning", "manual-testing", "automation-testing",
                   "api-testing", "performance-testing", "security-testing",
                   "accessibility-testing", "exploratory-testing", "regression-testing"],
    ...
    "performance-engineering": {
        ...
        "tech_stacks": ["jmeter", "k6", "locust", "gatling", "artillery",
                        "wrk", "ab", "hey", "vegeta"],
        "skills": ["load-testing", "stress-testing", "scalability-testing",
                   "profiling", "bottleneck-analysis", "capacity-planning",
                   "benchmark-design", "chaos-engineering"],
    ...
    "technical-writing": {
        ...
        "tech_stacks": ["markdown", "asciidoc", "restructuredtext", "dita",
                        "docusaurus", "mkdocs", "gitbook", "confluence",
                        "swagger-openapi", "postman-docs"],
        "skills": ["api-documentation", "user-guides", "tutorials", "reference-docs",
                   "release-notes", "architecture-docs", "runbooks", "rfcs",
                   "doc-as-code", "information-architecture", "style-guides"],
    ...
    "developer-relations": {
        ...
        "tech_stacks": ["documentation-platforms", "community-platforms", "sdk-tools",
                        "content-management", "analytics", "developer-portals"],
        "skills": ["community-building", "technical-blogging", "conference-speaking",
                   "sdk-design", "developer-experience", "feedback-loops",
                   "content-creation", "hackathon-organization", "advocacy"],
...
NON_TECH_ROLE_CATEGORIES = {
    "it-project-management": {
        ...
        "skills": ["project-planning", "risk-management", "stakeholder-management",
                   "budget-management", "resource-planning", "reporting",
                   "vendor-management", "change-management", "scope-management"],
    ...
    "program-management": {
        ...
        "skills": ["portfolio-management", "strategic-alignment", "governance",
                   "dependency-management", "executive-reporting", "benefits-realization",
                   "organizational-change", "roadmapping"],
    ...
    "scrum-master": {
        ...
        "skills": ["sprint-facilitation", "retrospectives", "impediment-removal",
                   "coaching", "conflict-resolution", "metrics-tracking",
                   "team-dynamics", "agile-transformation"],
    ...
    "product-management-tech": {
        ...
        "skills": ["product-discovery", "roadmapping", "user-research", "data-analysis",
                   "competitive-analysis", "prioritization", "go-to-market",
                   "a-b-testing", "kpi-definition", "stakeholder-alignment"],
    ...
    "business-analysis": {
        ...
        "skills": ["requirements-elicitation", "process-modeling", "gap-analysis",
                   "use-case-writing", "user-story-mapping", "bpml",
                   "data-analysis", "stakeholder-facilitation", "feasibility"],
    ...
    "it-strategy": {
        ...
        "skills": ["strategic-planning", "technology-roadmapping", "digital-transformation",
                   "investment-planning", "vendor-strategy", "innovation-management",
                   "executive-communication", "benchmarking"],
    ...
    "enterprise-architecture": {
        ...
        "skills": ["business-architecture", "application-architecture",
                   "data-architecture", "technology-architecture", "security-architecture",
                   "architecture-governance", "pattern-design", "roadmapping"],
    ...
    "it-governance": {
        ...
        "skills": ["policy-development", "control-design", "audit-support",
                   "risk-management", "compliance-monitoring", "vendor-governance",
                   "metrics-reporting", "board-reporting"],
    ...
    "vendor-management": {
        ...
        "skills": ["contract-negotiation", "vendor-selection", "sla-management",
                   "performance-monitoring", "relationship-management",
                   "spend-optimization", "risk-assessment", "sourcing-strategy"],
    ...
    "it-procurement": {
        ...
        "skills": ["rfp-rfq-management", "contract-management", "cost-benefit-analysis",
                   "market-analysis", "negotiation", "supplier-diversity",
    ...
    "it-finance": {
        ...
        "skills": ["it-budgeting", "cost-allocation", "financial-forecasting",
                   "chargeback-showback", "roi-analysis", "cloud-cost-management",
                   "capex-opex", "financial-reporting", "unit-economics"],
    ...
    "it-audit": {
        ...
        "skills": ["audit-planning", "control-testing", "evidence-collection",
                   "finding-documentation", "remediation-tracking", "report-writing",
                   "data-analytics-audit", "continuous-auditing"],
    ...
    "compliance-management": {
        ...
        "frameworks": ["gdpr", "ccpa", "hipaa", "pci-dss", "sox", "iso27001",
                       "nist-csf", "fedramp", "soc2"],
        "skills": ["regulatory-mapping", "gap-assessment", "policy-development",
                   "training-programs", "audit-preparation", "incident-reporting",
                   "data-privacy", "third-party-compliance"],
    ...
    "change-management-it": {
        ...
        "skills": ["change-impact-assessment", "stakeholder-engagement", "training-design",
                   "communication-planning", "resistance-management", "adoption-measurement",
                   "sponsorship-alignment", "sustainment"],
    ...
    "itsm-management": {
        ...
        "skills": ["incident-management", "problem-management", "change-management",
                   "service-catalog", "capacity-management", "availability-management",
    ...
    "it-training": {
        ...
        "skills": ["curriculum-design", "instructional-design", "e-learning",
                   "virtual-training", "assessment-design", "learning-analytics",
                   "lms-management", "mentoring", "coaching"],
    ...
    "it-recruiting": {
        ...
        "skills": ["sourcing-strategy", "technical-screening", "interview-design",
                   "candidate-experience", "employer-branding", "offer-management",
                   "talent-pipeline", "hiring-analytics"],
    ...
    "it-operations-management": {
        ...
        "skills": ["operations-planning", "team-leadership", "budget-management",
                   "vendor-oversight", "escalation-management", "kpi-reporting",
    ...
    "it-support-helpdesk": {
        ...
        "skills": ["troubleshooting", "active-directory", "o365-support",
                   "hardware-support", "software-installation", "remote-support",
                   "documentation", "escalation", "customer-service"],
    ...
    "it-marketing": {
        ...
        "skills": ["product-positioning", "content-marketing", "digital-marketing",
                   "event-marketing", "analyst-relations", "campaign-management",
    ...
    "customer-success-tech": {
        ...
        "skills": ["onboarding", "adoption-strategy", "churn-prevention", "upselling",
                   "technical-escalation", "success-planning", "advocacy",
                   "renewal-management", "executive-business-reviews"],
    ...
    "it-risk-management": {
        ...
        "skills": ["risk-identification", "risk-quantification", "risk-treatment",
                   "risk-monitoring", "third-party-risk", "operational-risk",
    ...
    "digital-transformation": {
        ...
        "skills": ["transformation-strategy", "innovation-management", "cultural-change",
                   "capability-building", "ecosystem-design", "data-strategy",
    ...
    "data-governance": {
        ...
        "skills": ["data-policy", "metadata-management", "data-quality-program",
                   "data-stewardship", "master-data", "data-lineage",
                   "privacy-governance", "data-literacy"],
    ...
    "it-communications": {
        ...
        "skills": ["executive-communications", "technical-writing", "newsletter",
                   "intranet-management", "town-halls", "crisis-communications",
...
EXPERIENCE_VARIANTS = [
    "generalist", "specialist", "consultant", "contractor", "advisor",
    "manager", "director", "vp", "cto", "cio", "ciso", "cdo",
    "team-lead", "tech-lead", "engineering-manager", "head-of",
    "remote", "hybrid", "on-site"
]

DOMAIN_SPECIALIZATIONS = [
    "startup", "enterprise", "government", "nonprofit", "regulated-industry",
    "global", "regional", "b2b", "b2c", "marketplace", "platform"
]
...
def generate_agent(role_id: str, category: str, category_data: dict,
                   variant: dict, agent_index: int, is_technical: bool) -> dict:
    ...
    agent = {
        ...
        "folder_structure_template": f"templates/project-structures/{primary_stack.split('-')[0]}-service" \
            if is_technical else "templates/project-structures/generic-project",
...
def save_agents(agents: list, output_dir: str):
    ...
    index = [{"id": a["id"], "name": a["name"], "role": a["role"],
               "type": a["type"], "seniority": a["seniority"]} for a in agents]
